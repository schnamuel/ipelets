...
* **grids**: For a set of selected marks this ipelet adds edges between a pair of marks if they are on adjacent points of the grid. This can be used to create induced subgraphs of grids or strong grids by adding the vertices and then adding the edges with this ipelet.
